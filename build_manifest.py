...
from ai_cull_assistant.version import BUILD, VERSION
...
(root/MANIFEST).write_text(json.dumps(dict(format='photo-cull-program-v1',version=VERSION,build=BUILD,files=files),ensure_ascii=False,indent=2),encoding='utf-8')
